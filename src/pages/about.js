        ...
        <div className="valuesCont">
          <div className="valueBox">
            ...
            <div className="valueBody">
              UNSW Illuminate is a student society that combines the creativity
              of art and the innovation of engineering to demonstrate the magic
          ...
          <div className="valueBox">
            ...
            <div className="valueBody">
              ...
              scale, professional, and multidisciplinary projects and to foster
              deep interactions designers and engineers.
            </div>
          </div>
          <div className="valueBox">
            <div className="valueHeading">Teamwork</div>
            <div className="valueBody">
              We aim to allow studetns to work together to realise and actualise
              their creative vision while gaining practical experience in the
              process.
            </div>
          </div>
        </div>
